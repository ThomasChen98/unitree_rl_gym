...
class LeggedRobot(BaseTask):
    ...
    def _get_noise_scale_vec(self, cfg):
        ...
        noise_vec[12 + 2 * self.num_actions : 12 + 3 * self.num_actions] = (
    ...
    def _init_buffers(self):
        ...
        print("len of self.p_gains:", len(self.p_gains))
    ...
    def _create_envs(self):
        ...
        print("Number of bodies in the asset:", self.num_bodies)
        print("Number of DOFs in the asset:", self.num_dof)
