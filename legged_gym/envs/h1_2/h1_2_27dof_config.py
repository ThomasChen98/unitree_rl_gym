...
class H1_2_27DofRoughCfg(LeggedRobotCfg):
    ...
    class control(LeggedRobotCfg.control):
        ...
        stiffness = {
            ...
            'shoulder_roll_joint': 60.,
            'shoulder_yaw_joint': 60.,
            'elbow_pitch_joint': 30.,
            'elbow_roll_joint': 30.,
            'wrist_pitch_joint': 15.,
            'wrist_yaw_joint': 15.,
        }  # [N*m/rad]
        damping = {
            'hip_yaw_joint': 4.0,
    ...
    class asset(LeggedRobotCfg.asset):
        file = '{LEGGED_GYM_ROOT_DIR}/resources/robots/h1_2/h1_2_27dof.urdf'
        name = "h1_2_27dof"
...
class H1_2_27DofRoughCfgPPO(LeggedRobotCfgPPO):
    class policy:
        init_noise_std = 0.8
